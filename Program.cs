            ...
            try
            {
                    ...
                    Console.WriteLine))
                {
                    ...
                    Assembly fmCommonAssembly =
                        assemblyLoader.LoadRequired("FMCommon.dll");

                    assemblyLoader.LoadIfPresent("FMBase.dll");
                    assemblyLoader.LoadIfPresent("Assembly-CSharp.dll");

                    Assembly gameAssembly =
                        assemblyLoader.LoadRequired("GameProj.dll");

                    string metaPath =
                        assemblyLoader.FindFile("Meta.bytes");

                    if (metaPath == null)
                    {
                        throw new FileNotFoundException(
                            "Meta.bytes was not found in: " +
                            inputFolder);
                    }
                    ...
                    Console.WriteLine(
                        "Tables discovered:  " +
                        summary.TablesDiscovered.ToString("N0"));
                    Console.WriteLine(
                        "Tables exported:    " +
                        summary.TablesExported.ToString("N0"));
                    Console.WriteLine(
                        "Tables empty:       " +
                        summary.TablesEmpty.ToString("N0"));
                    Console.WriteLine(
                        "Tables unsupported: " +
                        summary.TablesUnsupported.ToString("N0"));
                    Console.WriteLine(
                        "Tables failed:      " +
                        summary.TablesFailed.ToString("N0"));
                    Console.WriteLine(
                        "Rows exported:      " +
                        summary.RowsExported.ToString("N0"));
                    Console.WriteLine();
